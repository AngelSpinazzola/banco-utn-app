...
<nav>
	...
	<div class="side-bar" id="sidebar">
		...
		<div class="menu">
			<div class="item">
				<a href="ClientePanelSv"><i class="fas fa-home"></i>Inicio</a>
			</div>
			<div class="item">
				<a href="ClienteInfoPersonalSv"><i class="fa-regular fa-address-card"></i>Información personal</a>
			</div>
			<div class="item">
			...
			<div class="item">
				...
				<div class="sub-menu">
					...
					<a href="ClientePrestamosSv"class="sub-item"><i class="fa-solid fa-coins"></i>Mis préstamos</a>
				</div>
			</div>
		</div>
	</div>
