...
<nav>
	...
	<div class="side-bar" id="sidebar">
		...
		<div class="menu">
			<div class="item">
				<a href="DashboardServlet"><i class="fas fa-home"></i>Inicio</a>
			</div>
			<div class="item">
				<a href="ListarClientesSv"><i class="fa-solid fa-users"></i>Clientes</a>
			</div>
			<div class="item">
				...
				<div class="sub-menu">
					...
					<a href="AdminPrestamosSv"class="sub-item"><i class="fas fa-list-alt"></i>Resumen de préstamos</a> 
				</div>
			</div>
		</div>
	</div>
